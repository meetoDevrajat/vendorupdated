...
<body>
<%String aaas=request.getParameter("use");
session.setAttribute("username",aaas);%>
<div>
...
<br>
  <br>
    ...
    <li><a href="inventory"  class="active ac" >Inventory</a></li>
        	   ...
        	   <td>"${i.stock}"</td>
        	    <td>"${i.req}"</td>
        	     <td>"${i.buffer}"</td>
        	      <td>"${i.rating}"</td>
        	       <td>"${i.price}"</td>
        	<td><p size=12><a href=# class="bbb">Manage</a></td>
